...
/**
 ...
 @return 解密后的数据
 */
+(NSMutableDictionary *)decryptNetData:(id)responeObj reqModel:(YHBaseReqModel *)reqModel;
...
/**
 ...
 @return 解密后的数据
 */
+(NSMutableDictionary *)decryptNetData:(id)responeObj reqModel:(YHBaseReqModel *)reqModel isSign:(BOOL)isSign signBlackList:(NSArray <NSString *> *)signBlackList;
...
/**
  ...
  */
+(NSMutableDictionary *)decryptNetData:(id)responeObj reqModel:(YHBaseReqModel *)reqModel isSign:(BOOL)isSign signBlackList:(NSArray <NSString *> *)signBlackList iv:(NSString *)iv encodeType:(NSString *)encodeType;
...
/**
 ...
 @return 加密后的数据
 */
+(NSMutableDictionary *)encryptNetData:(YHBaseReqModel *)reqModel signBlackList:(NSArray <NSString *> *)signBlackList;
...
/**
 ...
 @return 加密后的数据
 */
+(NSMutableDictionary *)encryptNetData:(YHBaseReqModel *)reqModel signBlackList:(NSArray <NSString *> *)signBlackList iv:(NSString *)iv encodeType:(NSString *)encodeType;
